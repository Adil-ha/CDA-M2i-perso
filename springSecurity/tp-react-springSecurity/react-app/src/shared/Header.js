                    ...
                    {!isLoggedIn() ? (
                        ...
                        <>
                            <li className="nav-item mr-4" style={{ listStyleType: 'none' }}>
                                <NavLink className="btn btn-outline-success me-2" to={'/login'}>Connexion</NavLink>
                            </li>
                    
                            <li className="nav-item" style={{ listStyleType: 'none' }}>
                                <NavLink className="btn btn-outline-primary"  to={'/register'}>Créer un compte</NavLink>
                            </li>'
                        </>
                    ) : (
